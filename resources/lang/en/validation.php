...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'email' => [
            'unique' => 'Email ini telah digunakan',
        ],
        'password' => [
            'min' => 'minimal :min karakter.',
        ...
        'phone' => [
            'numeric' => 'Isian Nomor Telepon harus berupa angka.',
            'unique' => 'Nomor telepon ini telah digunakan',
            'min' => 'minimal :min digit',
        ],
        'g-recaptcha-response' => [
            'required' => 'Anda Belum Mengklik Captcha'
        ],
        'title' => [
            'min' => 'Judul tidak boleh kurang dari :min karakter',
        ],
        'opened_at' => [
