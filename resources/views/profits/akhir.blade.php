...
<div class="container">
  ...
  @endif
  <h1 class="text-center">Halaman Bagi Profit Akhir</h1>
  <hr>
  <br>
  <div class="row">
    ...
    <div class="col-md-5 border" style="border-radius: 10px">
      <br><br>
      <h3 class="text-center">Bagi Profit Akhir</h3>
      <form method="POST" action="/profitAkhir/{{$project->slug}}" enctype="multipart/form-data" id="myForm">
        ...
        <div class="form-group">
          <label for="status" class="">{{ __('Status Profit Akhir') }}</label>
